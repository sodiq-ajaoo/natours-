...
const userSchema = new mongoose.Schema({
  name: {
    type: String,
    requireed: [true, 'please tell us your name '],
  },
  email: {
    type: String,
...
//   // onl run this function if password was acttually modified
...
//     console.log(changedTimerstamp, JWTimestamp);
//   }
